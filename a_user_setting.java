...
import javax.swing.*;
import java.sql.*;
public class a_user_setting 
{
	public a_user_setting()
	{
		...
		JButton button=new JButton("Add New Customer");
		...
		JButton button1=new JButton("Update the Customer Details");
		...
		JButton button2=new JButton("View the Customer Details");
		...
		JButton button3=new JButton("Search the Customer");
		...
		JButton button4=new JButton("Delete the Customer Record");
